...
public class AgentDirectory implements MASInfrastructure.Directory.IAgentDirectory {

    private List<MASInfrastructure.Directory.IAgentListener> agentListeners;
    private List<MASInfrastructure.Directory.IReferenceAgentListener> referenceAgentListeners;
    private List<MASInfrastructure.Directory.IMessageAgentListener> messageAgentListeners;
    ...
    public List<MASInfrastructure.Directory.IMessageAgentListener> getMessageAgentListeners() {
